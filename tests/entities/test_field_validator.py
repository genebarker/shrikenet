...
def confirm_call_raises(
    function_call, field_name, field_value, expected_message
):
    ...
    def confirm_raises(
        ...
        with pytest.raises(ValueError) as excinfo:
            FieldValidator.validate_int(
                given_value, field_name, lower_limit
            )
        assert str(excinfo.value) == expected_message
...
class TestUsernameValidation:
    ...
    out_of_range_message = (
        "username must be between {0} and {1} characters long".format(
            FieldValidator.username_min_length,
    ...
    @staticmethod
    def confirm_raises(
        expected_message, given_username, field_name="username"
    ):
        confirm_call_raises(
            function_call=FieldValidator.validate_username,
    ...
    def test_none_with_alternate_name_raises(self):
        ...
        self.confirm_raises(
            expected_message, username, alternate_field_name
        )
...
class TestNameValidation:
    ...
    out_of_range_message = (
        "name must be between {0} and {1} characters long".format(
            FieldValidator.name_min_length, FieldValidator.name_max_length
        )
    )
    bad_characters_message = (
    ...
    def confirm_raises(expected_message, given_name, field_name="name"):
        confirm_call_raises(
            function_call=FieldValidator.validate_name,
            field_name=field_name,
...
class TestDescriptionValidation:
    ...
    out_of_range_message = (
        "description must be between {0} and {1} characters long".format(
            FieldValidator.description_min_length,
    ...
    def test_good_returns_its_value(self):
        ...
        assert (
            FieldValidator.validate_description(description) == description
        )
    ...
    def confirm_raises(expected_message, given_description):
        confirm_call_raises(
            function_call=FieldValidator.validate_description,
...
class TestTitleValidation:
    ...
    out_of_range_message = (
        "title must be between {0} and {1} characters long".format(
            FieldValidator.title_min_length, FieldValidator.title_max_length
        )
    )
    ...
    def confirm_raises(expected_message, given_title):
        confirm_call_raises(
            function_call=FieldValidator.validate_title,
            field_name="title",
...
class TestTagValidation:
    ...
    out_of_range_message = (
        "tag must be between {0} and {1} characters long".format(
            FieldValidator.tag_min_length, FieldValidator.tag_max_length
        )
    )
    bad_characters_message = (
    ...
    def confirm_raises(expected_message, given_tag, field_name="tag"):
        confirm_call_raises(
            function_call=FieldValidator.validate_tag,
            field_name=field_name,
...
class TestInstantValidation:
    ...
    def test_good_returns_its_value(self):
        assert (
            FieldValidator.validate_instant(self.GOOD_INSTANT)
            == self.GOOD_INSTANT
        )
    ...
    @staticmethod
    def confirm_raises(
        expected_message, given_instant, field_name="instant"
    ):
        confirm_call_raises(
            function_call=FieldValidator.validate_instant,
            field_name=field_name,
    ...
    def test_non_datetime_with_alternate_name_raises(self):
        ...
        self.confirm_raises(
            expected_message, instant, field_name=alternate_field_name
        )
